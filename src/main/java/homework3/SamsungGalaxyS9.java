...
public class SamsungGalaxyS9 extends Samsung implements Phone {
    private String color;
    private String material;
    private String imei;

    public SamsungGalaxyS9(String color, String material, String imei, String manufacturer, String model) {
        super();
        this.color = color;
